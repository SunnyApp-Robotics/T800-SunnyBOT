...
: ${AMENT_CURRENT_PREFIX:="/home/jeison/T800-SunnyBOT/ros_ws/install/common"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/common/environment/pythonpath.sh"
